...
const DataJob = {
    ...
    JobTitle(){
        ...
        cy.get(".oxd-form .oxd-input").type("QA Quality Tester");
    ...
    PayGrade(){
        ...
        cy.get(".oxd-button").click();
        cy.get(".oxd-input-group .oxd-input").type("Wawan Quality Assurance");
        cy.get(".oxd-button--secondary").click();
    },
    EmploymentStatus(){
         cy.get(".oxd-dropdown-menu").contains("Employment Status").click();
         cy.get(".oxd-button").click();
         cy.get(".oxd-input-group .oxd-input").type("Fultime Contract");
         cy.get(".oxd-button--secondary").click();
    },
    JobCategories(){
        cy.get(".oxd-dropdown-menu").contains("Job Categories").click();
        cy.get(".oxd-button").click();
        cy.get(".oxd-input-group .oxd-input").type("Quality Assurance");
        cy.get(".oxd-button--secondary").click();
    },
    WorkShifts(){
         cy.get(".oxd-dropdown-menu").contains("Work Shifts").click();
         cy.get(".oxd-button").click();
         cy.get(".oxd-form .oxd-grid-2 .oxd-input").type("Quality Assurance Type");
         //from
         ...
         cy.get("[placeholder='Type for hints...']").wait(2000).type("aish");
